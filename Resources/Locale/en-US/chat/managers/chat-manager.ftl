...
# #Cythisiax Edited - wrap name in [Name] tags so client can apply chat name color
# #Cythisiax Fixed - Capitalize "The" for sentence-start emote messages when no ID is present
